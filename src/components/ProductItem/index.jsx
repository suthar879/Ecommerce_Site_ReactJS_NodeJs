...
const ProductItem = () => {
  return (
    <div className="productItem rounded-md overflow-hidden my-6 border-2 border-[rgba(0,0,0,.1)] shadow-lg">
      ...
      <div className="info p-3 py-4">
        ...
        <h3 className="text=[14px] title mt-2 link transition-all text-black">
          <Link to="/">
